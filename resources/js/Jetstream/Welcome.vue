  ...
  <div>
    <div class="p-6 sm:px-20 bg-gray-200 border-b border-gray-200">
      ...
      <div class="text-2xl mt-6 text-gray-900">
        <p>
          Thank you for visiting Pad6y.com home to my portfolio. Here you will
          find projects I have been working on during my path to web
          development. Here I will try my best to demonstrate and use the
          knowledge I have gain during many many hours of Udemy courses and
          youTube tutorials.
        </p>
        <br />
        <p>
          Everyday my goal is to learn something new and to revisit course
          materials to further my knowledge on specific topics.
        </p>
        <br />
        <p>
          If you like to know more about my path to learning web development
          please click on the link about Education. Here I will go further into
          detail where my journey began and more specifically a list of
          languages, frameworks and tools I have used.
        </p>
        <br />
        <p>
          To learn more about me please click on the BIO links. For my projects
          the above links are self explanatory.
        </p>
      </div>
    </div>
